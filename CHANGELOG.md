...
### Dependencies
- Bump `actions/checkout` from 4 to 6 ([#31](https://github.com/Cray-HPE/requests-retry-session/pull/31), [#35](https://github.com/Cray-HPE/requests-retry-session/pull/35))
